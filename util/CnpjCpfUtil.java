...
public class CnpjCpfUtil {
	...
	public static String imprimeCNPJBarra(String CNPJ) {
		// m�scara do CNPJ: 99.999.999/9999-99
		return (CNPJ.substring(0, 2) + "." + CNPJ.substring(2, 5) + "." + CNPJ.substring(5, 8) + "/" + CNPJ.substring(8, 12) + "-" + CNPJ.substring(12, 14));
	}
	
	public static String getCpfMascarado(String cpf) {
		if(cpf==null || cpf.isEmpty() || cpf.length()!=14)
			return "";
		else {
			String retorno = cpf.substring(0,3);
			retorno= retorno+".xxx.xxx-";
			retorno= retorno+cpf.substring(12,14);
			return retorno;
		}
	}
